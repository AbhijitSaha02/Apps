...
class RecyclerAdapterPopular(private var movieData: List<MoviePopular.MoviePopularResults>?) :
    RecyclerView.Adapter<RecyclerAdapterPopular.ViewHolder>() {
    ...
    class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(m: MoviePopular.MoviePopularResults) {
            ...
            moviePlay.setOnClickListener {
                ...
                Log.d("RecyclerAdapterPopular", "Clicked " + m.title.toString())
            }
        }
    }
